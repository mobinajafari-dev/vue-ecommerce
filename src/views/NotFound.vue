<template>
    <div id="page404">
        ...
        <div class="error__content">
            <p class="error__title__italic">Ooooops !</p>
        <h1 class="error__title">404 - Page Not Found</h1>
        <p class="error__txt">The page you are looking for might have been removed or<br/> had it's name changed or is temporarily unavailable...</p>
